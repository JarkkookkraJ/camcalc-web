...
import { renderResults, readInputs, setError, getUnit, setUnit } from "./ui";
...
function computeAndRender(): void {
  try {
    ...
    renderResults(resultsNode, res, unit);
  } catch (e: unknown) {
    console.error(e);
...
export function init(): void {
  ...
  ["width_px","height_px","dfov_deg","projection","range_m"].forEach(id => {
